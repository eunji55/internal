        ...
        <div class="row">
            <section class="panel">
              ...
              <div class="panel-body">
                    ...
                    <div class="form-group">
                      <label for="ccomment" class="control-label col-lg-2" style="padding-top:0px;">공지로 등록</label>
                      <div class="col-lg-8">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('input[id="noticeYN"]').change(function(){
