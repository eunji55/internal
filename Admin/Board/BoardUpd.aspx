...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <section class="panel">
               <div class="form-horizontal" style="font-size:150%;">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      <label for="cname" class="control-label col-lg-2" style="padding-top:0px;">공지로 등록<span class="required">*</span></label>
                      <div class="col-lg-8">
                          <asp:CheckBox id="noticeYN" name="noticeYN" runat="server" />
                      </div>
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if ($('input[id="<%=noticeYN.ClientID%>"]:checked')) {
                $(this).attr("value","Y");
            } else {
                $(this).attr("value", "N");
            }

            $('input[id="<%=noticeYN.ClientID%>"]').change(function () {
        ...
        function boardUpd() {
             $("#btnUpdate").on("click", function () {
                ...
                reqParam["strNoticeYN"] = $("#<%=noticeYN.ClientID%>").val();
