...
public partial class UserMng_PurchaseDetail : System.Web.UI.Page
{
    ...
    private Int64 purchaseNo = 0;

    protected void Page_Load(object sender, EventArgs e)
    {
        purchaseNo = Convert.ToInt64(Request.QueryString["purchaseNo"]);
        purchaseNoVal.Value = purchaseNo.ToString();
